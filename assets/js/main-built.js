...
(function (e, t) {
    ...
    function i(e, n, r, i) {
        if (ut.acceptData(e)) {
            var s, o, u = ut.expando, a = "string" == typeof n, f = e.nodeType, l = f ? ut.cache : e,
                c = f ? e[u] : e[u] && u;
    ...
    function C(e, t, n) {
        var r = !0, i = "width" === t ? e.offsetWidth : e.offsetHeight, s = fn(e),
    ...
    var X, V, $ = e.document, J = e.location, K = e.jQuery, Q = e.$, G = {}, Y = [], Z = "1.9.0", et = Y.concat,
        tt = Y.push, nt = Y.slice, rt = Y.indexOf, it = G.toString, st = G.hasOwnProperty, ot = Z.trim,
        ut = function (e, t) {
            return new ut.fn.init(e, t, X)
        }, at = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ft = /\S+/g, lt = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
        ct = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, ht = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, pt = /^[\],:{}\s]*$/,
        dt = /(?:^|:|,)(?:\s*\[)+/g, vt = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,
        mt = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, gt = /^-ms-/, yt = /-([\da-z])/gi,
        bt = function (e, t) {
    ...
    ut.Callbacks = function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, r, i = 0, s = nt.call(arguments), o = s.length,
                u = 1 !== o || e && ut.isFunction(e.promise) ? o : 0, a = 1 === u ? e : ut.Deferred(),
                f = function (e, n, r) {
                    return function (i) {
    ...
    var Tt, Nt, Ct = /[\t\r\n]/g, kt = /\r/g, Lt = /^(?:input|select|textarea|button|object)$/i, At = /^(?:a|area)$/i,
        ...
        Mt = /^(?:checked|selected)$/i, _t = ut.support.getSetAttribute, Dt = ut.support.input;
    ut.fn.extend({
        attr: function (e, t) {
        ...
        get: function (e, n) {
            var r = ut.prop(e, n), i = "boolean" == typeof r && e.getAttribute(n),
    ...
    var Pt = /^(?:input|select|textarea)$/i, Ht = /^key/, Bt = /^(?:mouse|contextmenu)|click/,
        jt = /^(?:focusinfocus|focusoutblur)$/, Ft = /^([^.]*)(?:\.(.+)|)$/;
    ut.event = {
        global: {},
        ...
        dispatch: function (e) {
            e = ut.event.fix(e);
            var n, r, i, s, o, u = [], a = nt.call(arguments), f = (ut._data(this, "events") || {})[e.type] || [],
        ...
        function m(e, t, n, r, s, o) {
            return r && !r[I] && (r = m(r)), s && !s[I] && (s = m(s, o)), i(function (i, o, u, a) {
                var f, l, c, h = [], p = [], d = o.length, m = i || b(t || "*", u.nodeType ? [u] : u, []),
                    g = !e || !i && t ? m : v(m, h, e, u, a), y = n ? s || (i ? e : d || r) ? [] : o : g;
        ...
        function y(e, t) {
            var n = 0, r = t.length > 0, s = e.length > 0, u = function (i, u, a, f, l) {
                var c, h, p, d = [], m = 0, g = "0", y = i && [], b = null != l, w = A,
                    E = i || s && T.find.TAG("*", l && u.parentNode || u), S = U += null == w ? 1 : Math.E;
        ...
        var S, x, T, N, C, k, L, A, O, M, _, D, P, H, B, j, F, I = "sizzle" + -(new Date), q = e.document, R = {},
            U = 0, z = 0, W = r(), X = r(), V = r(), $ = typeof t, J = 1 << 31, K = [], Q = K.pop, G = K.push,
            Y = K.slice, Z = K.indexOf || function (e) {
            ...
            ot = RegExp("^" + et + "+|((?:^|[^\\\\])(?:\\\\.)*)" + et + "+$", "g"),
            at = RegExp("^" + et + "*," + et + "*"), ft = RegExp("^" + et + "*([\\x20\\t\\r\\n\\f>+~])" + et + "*"),
            lt = RegExp(st), ct = RegExp("^" + nt + "$"), ht = {
                ID: RegExp("^#(" + tt + ")"),
                CLASS: RegExp("^\\.(" + tt + ")"),
                NAME: RegExp("^\\[name=['\"]?(" + tt + ")['\"]?\\]"),
            ...
            }, pt = /[\x20\t\r\n\f]*[+~]/, dt = /\{\s*\[native code\]\s*\}/, vt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
            mt = /^(?:input|select|textarea|button)$/i, gt = /^h\d$/i, yt = /'|\\/g,
    ...
    var It = /Until$/, qt = /^(?:parents|prev(?:Until|All))/, Rt = /^.[^:#\[\.,]*$/, Ut = ut.expr.match.needsContext,
    ...
    var Wt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        Xt = / jQuery\d+="(?:null|\d+)"/g, Vt = RegExp("<(?:" + Wt + ")[\\s/>]", "i"), $t = /^\s+/,
        Jt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Kt = /<([\w:]+)/,
        Qt = /<tbody/i, Gt = /<|&#?\w+;/, Yt = /<(?:script|style|link)/i, Zt = /^(?:checkbox|radio)$/i,
    ...
    var an, fn, ln, cn = /alpha\([^)]*\)/i, hn = /opacity\s*=\s*([^)]*)/, pn = /^(top|right|bottom|left)$/,
        dn = /^(none|table(?!-c[ea]).+)/, vn = /^margin/, mn = RegExp("^(" + at + ")(.*)$", "i"),
        gn = RegExp("^(" + at + ")(?!px)[a-z%]+$", "i"), yn = RegExp("^([+-])=(" + at + ")", "i"), bn = {BODY: "block"},
        wn = {position: "absolute", visibility: "hidden", display: "block"}, En = {letterSpacing: 0, fontWeight: 400},
    ...
    ut.fn.extend({
        ...
        get: function (e, t) {
            ...
            var n = e.style, r = e.currentStyle, i = ut.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
    ...
    var Tn = /%20/g, Nn = /\[\]$/, Cn = /\r?\n/g, kn = /^(?:submit|button|image|reset)$/i,
    ...
    var An, On, Mn = ut.now(), _n = /\?/, Dn = /#.*$/, Pn = /([?&])_=[^&]*/, Hn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        Bn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, jn = /^(?:GET|HEAD)$/, Fn = /^\/\//,
        In = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, qn = ut.fn.load, Rn = {}, Un = {}, zn = "*/".concat("*");
    try {
        On = J.href
    } catch (Wn) {
    ...
    An = In.exec(On.toLowerCase()) || [], ut.fn.load = function (e, n, r) {
        ...
        ajax: function (e, n) {
            ...
            var i, s, o, u, a, f, l, c, h = ut.ajaxSetup({}, n), p = h.context || h,
                d = h.context && (p.nodeType || p.jquery) ? ut(p) : ut.event, v = ut.Deferred(),
                m = ut.Callbacks("once memory"), g = h.statusCode || {}, y = {}, b = {}, w = 0, E = "canceled", S = {
    ...
    ut.ajaxSetup({
        ...
        var s, o, u,
            a = n.jsonp !== !1 && (Vn.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && Vn.test(n.data) && "data");
    ...
    var Gn, Yn, Zn = /^(?:toggle|show|hide)$/, er = RegExp("^(?:([+-])=|)(" + at + ")([a-z%]*)$", "i"),
        tr = /queueHooks$/, nr = [R], rr = {
            "*": [function (e, t) {
    ...
    ut.Animation = ut.extend(I, {
        ...
        fadeTo: function (e, t, n, r) {
            ...
            return e !== !1 && (e = e || "fx"), this.each(function () {
                var t, n = ut._data(this), r = n[e + "queue"], i = n[e + "queueHooks"], s = ut.timers,
                    o = r ? r.length : 0;
        ...
        setOffset: function (e, t, n) {
            ...
            var i, s, o = ut(e), u = o.offset(), a = ut.css(e, "top"), f = ut.css(e, "left"),
                l = ("absolute" === r || "fixed" === r) && ut.inArray("auto", [a, f]) > -1, c = {}, h = {};
    ...
    s.extend(f.prototype, a, {
        changed: null, _silent: null, _pending: null, idAttribute: "id", initialize: function () {
            ...
            var u = n.changes = {}, a = this.attributes, l = this._escapedAttributes,
    ...
    t = {
        version: "2.0.5", strip: function (e) {
            ...
            c.isBuild = i.isBuild;
            var s = t.parseName(e), l = s.moduleName + (s.ext ? "." + s.ext : ""), h = n.toUrl(l),
                p = c.useXhr || t.useXhr;
    ...
    var t = e("text!templates/snippet/formname.html"), n = e("text!templates/snippet/prependedtext.html"),
        r = e("text!templates/snippet/searchinput.html"), i = e("text!templates/snippet/textinput.html"),
        s = e("text!templates/snippet/appendedcheckbox.html"), o = e("text!templates/snippet/appendedtext.html"),
        u = e("text!templates/snippet/filebutton.html"), a = e("text!templates/snippet/button.html"),
        f = e("text!templates/snippet/buttondouble.html"), l = e("text!templates/snippet/buttondropdown.html"),
        c = e("text!templates/snippet/multiplecheckboxes.html"),
        h = e("text!templates/snippet/multiplecheckboxesinline.html"),
        p = e("text!templates/snippet/multipleradios.html"), d = e("text!templates/snippet/multipleradiosinline.html"),
        v = e("text!templates/snippet/passwordinput.html"), m = e("text!templates/snippet/prependedcheckbox.html"),
        n = e("text!templates/snippet/prependedtext.html"), g = e("text!templates/snippet/searchinput.html"),
        y = e("text!templates/snippet/selectbasic.html"), b = e("text!templates/snippet/selectmultiple.html"),
        w = e("text!templates/snippet/textarea.html"), i = e("text!templates/snippet/textinput.html");
    return {
        formname: t,
        prependedtext: n,
        search: r,
